...
<center>
  <div>
<a href="login.php"><img src="resources\login.png" class="rounded-circle" style="width: 184px; margin-top: 85px; margin-right: 50px"><!--login/logout--></a>
<a href="register.php"><img src="resources\mProfile.png" class="rounded-circle" style="width: 200px; margin-top: 85px;"><!--register/edit your profile--></a>
</div>
	</center>
</body>
</html>
