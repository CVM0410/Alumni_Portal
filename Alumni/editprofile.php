...
function active_button5() {
  ...
  <div class="container">
  <img src="resources\mProfile.png" class="rounded-circle" style="width: 140px; margin-top: 5px;">
</div>
  </body>
</html>