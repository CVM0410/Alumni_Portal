...
<br>
  <div class="container">
<div class="container" style="border: 1px solid #bfbfbf; margin-top: 30px;">
  <a href="profile.html"><img src="resources\mProfile.png" class="rounded-circle" style="width: 55px; margin-top: 5px;"><b style="margin-right: 10px">Firstname Surname</b></a><a>@Software Engineer, Capgemini</a>
